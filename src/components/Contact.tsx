    ...
    <section id="contact" className="py-20 bg-gray-50 dark:bg-gray-800">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          <div className="bg-white dark:bg-gray-900 rounded-lg shadow-md p-8 hover:shadow-lg transition-shadow duration-300">
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <a 
                    href="mailto:sugumanchi.it@gmail.com" 
                    className="text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-300"
                  >
                sugumanchi.it@gmail.com
                  </a>
                </div>
              </div>
            ...
            <div className="mt-8 pt-8 border-t border-gray-200 dark:border-gray-700">
              ...
              <div className="flex gap-4">
                <a 
                  ...
                  className="w-10 h-10 rounded-full bg-gray-100 dark:bg-gray-800 flex items-center justify-center text-gray-700 dark:text-gray-300 hover:bg-blue-100 hover:text-blue-600 dark:hover:bg-blue-900/30 dark:hover:text-blue-400 transition-colors duration-300"
                  aria-label="GitHub"
                >
